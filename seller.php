  ...
  <div class="body-section">
    ...
    <div class="body-right-section">
      ...
      <div class="right-middle">
        <p class="recent-order-text">Recent Orders</p>

        <div class="order-details">

          <div class="order-item">
            <div class="order-item-left">
              <img src="cat.jpg" alt="Product Image" class="customer-image">

              <div class="order-item-left-info">
                <p class="order-no">Order #1234</p>
                <p class="product-status">Wireless Headphones • 2 items</p>
              </div>
            </div>

            <div class="order-item-right">
              <button class="status-btn">Processing</button>
            </div>
          </div>
          ...
          <div class="order-item">
            <div class="order-item-left">
              ...
              <div class="order-item-left-info">
                <p class="order-no">Order #1235</p>
                <p class="product-status">Smart Watch • 1 item</p>
              </div>
            </div>
          ...
          <div class="order-item">
            <div class="order-item-left">
              ...
              <div class="order-item-left-info">
                <p class="order-no">Order #1236</p>
                <p class="product-status">Laptop Stand • 3 items</p>
              </div>
            </div>

            <div class="order-item-right">
              <button class="status-btn completed">Completed</button>
            </div>
          </div>
